...
final class FeedAcceptanceTests: XCTestCase {
    ...
    func test_onLaunch_displaysCachedRemoteFeedWhenCustomerHasNoConnectivity() {
        ...
        XCTAssertEqual(offlineFeed.renderedFeedImageData(at: 0)?.count ?? 0, makeImageData0().count)
        XCTAssertEqual(offlineFeed.renderedFeedImageData(at: 1)?.count ?? 0, makeImageData1().count)
    }
